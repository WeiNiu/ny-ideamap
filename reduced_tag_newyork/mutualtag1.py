...
filedir='./reduced_dict_to_0.005_total_newyork1'

outfiledir='./similarity2011_2_withuid_9'
def MutualTag(dir):
    file = open(dir,'r')
   #file.readline()
...
#            print totaltagmul,vectorlenmul
           # print len(intersect)
           # vectorSimilarityDict[loc1][loc2]=1/(1/(roughDist**2)*(size_uidsect+1)**5*(length/10)**3)
           # print 1000/(roughDist**2)*(size_uidsect+1)**3 
           # print vectorSimilarityDict[loc1][loc2]
            vectorSimilarityDict[loc1][loc2]=1/(1/(roughDist**2)*(size_uidsect+1)**5*(1000000000*totaltagmul/vectorlenmul)**2)
