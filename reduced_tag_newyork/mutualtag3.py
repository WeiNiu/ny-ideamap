...
filedir='./reduced_dict_to_0.005_total_newyork2'
outfiledir='./similarity_cut_exp_0.005_1'
def MutualTag(dir):
    file = open(dir,'r')
   #file.readline()
...
#            print totaltagmul,vectorlenmul
          ...
          # # vectorSimilarityDict[loc1][loc2]=1/(1/(roughDist**2)*(size_uidsect+1)**3*length**2)
           ...
           # print xxx
            vectorSimilarityDict[loc1][loc2]=1/(exp(-roughDist/4)*(size_uidsect+1)**5*(xxx*1000000)**2)
