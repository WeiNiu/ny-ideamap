...
import os
#import json
dir1='/home/wei/geo_hashtag_data/2011_10.txt'
...
#                print tweet['h']
            if 'geo' in tweet.keys():
                loc=CheckLocation(tweet['geo'], 0.1,-125.77,-66.95,22.52,49.38)
            elif 'bb' in tweet.keys():
                loc=CheckLocation(tweet['bb'], 0.1,-125.77,-66.95,22.52,49.38)
            #else: pass
            for tag in tweet['h']:
...
f=open('/home/wei/ideamap/dict2011_10.txt','w') 
